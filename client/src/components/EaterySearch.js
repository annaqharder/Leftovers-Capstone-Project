...
function EaterySearch({searchQuery, setSearchQuery, filterBy, setFilterBy, sortBy, setSortBy}) {
    ...
    return (
        <section class="flex p-1">
            <div class="flex px-4">
                <div class="text-2xl my-2 mr-4 font-bold "> Search:</div>
                    <input
                        class="px-4 py-3 text-xl border border-solid focus:text-gray-700 rounded"
            ...
            <div class="flex px-4">
                <div class="text-2xl my-2 font-bold"> Sort by:</div>
                    <label class="text-xl p-3">
                        <input
                        class="mr-1"
                        type="radio"

...
E3 = Eatery.create!(eatery_name: "Dandy Lion Coffee Co.", eatery_address: "5225 E 38th Ave. Denver, CO 80207", eatery_neighborhood: "North Park Hill", eatery_category: "Coffee/Cafe", eatery_type: "", user_id: anna.id)
...
V5 = Visit.create!(user_id: anna.id, eatery_id: E3.id, date:"2023-01-28", occasion: "Studying", notes: "pastry was delicious", drink: "Thai Ice Tea", appetizer: "", food: "caramel apple pastery", dessert: "", other_consumables: "", visit_img:"", rating: 4)
